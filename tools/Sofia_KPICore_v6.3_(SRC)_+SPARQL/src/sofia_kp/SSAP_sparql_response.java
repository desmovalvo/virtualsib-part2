...
public class SSAP_sparql_response {
	...
	{		
		...
		if(ssap_sparql_response==null){System.out.println("ERROR:SSAP_sparql_response:Constructor:XML message is null");System.exit(2);}
	...
	{		
		...
		try
		{
			...
			List<Element> head= ssap_sparql_response_element.getChildren();
 ...
 */
						...
						while(bindingListIter.hasNext())
						{
							...
							while (bindindChildrenIter.hasNext()) {
								...
								else
								{
									...
									System.out.println(bindingchild.getName());
								}
							}
	...
	public static String getCellType(String[] cell){
		//	        restituisci cell[3] che contiene il VALORE del type (xml:lang = ..., oppure datatype=...)
	...
	public Vector<String[]> getNextRow(){
		...
		//		TODO: maybe add a "Throws Exception" declaration to avoid exit(1) or syserr messages
