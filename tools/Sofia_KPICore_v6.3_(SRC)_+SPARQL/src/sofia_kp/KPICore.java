...
public class KPICore implements iKPIC, iKPIC_subscribeHandler 
{
    ...
    private int            PORT     = -1;
    private String         SMART_SPACE_NAME=null;
	...
	private final String AR_Target    = AR_NameSpace+"#Has_Target";             //FIXME This will be changed (AR = access restriction)
       ...
       */
       ...
       public void disenable_error_message(){PRINT_ALL_ERR=false;}
       public void disenable_debug_message(){PRINT_ALL_DEBUG=false;}
...
return sendSSAPMsg( this.xmlTools.update_sparql(sparql_update ));
       ...
       }//public String subscribeRDF(String query)
       ...
       private void startEventHandlerThread(Socket socket,BufferedReader in,PrintWriter out)
       {
           ...
           eventThread = new Thread()
           {
               ...
               int buffsize= 4 *1024;
                  ...
                  try
                  {
                          while ((charRead = ft_in.read(buffer, 0, buffer.length)) != (-1)) 
                          {
                                  builder.append(buffer, 0 , charRead);
                                //  System.out.println("Into while msg=" + builder.toString());
...
//                      
//                                              
////                       if(  msg_event.startsWith("<SSAP_message>") 
////                       	   && msg_event.endsWith("</SSAP_message>"))
//                       if(  msg_event.contains("<SSAP_message>") 
//               	            && msg_event.contains("</SSAP_message>"))
//                       { 
//
...
//                         	 return;
//                         	}//if(xmlTools.isUnSubscriptionConfirmed(msg_event))
//                          else {deb_print("KpCore:EventHandlerThread:NO, thiss is not a UnSubscriptionConfirmed");}
//
//                    	   
//                    	deb_print("KpCore:EventHandlerThread:passing the event message passed to event handler...:"+msg_event.replace("\n", ""));   
//                       	f_eh.kpic_SIBEventHandler( msg_event );
